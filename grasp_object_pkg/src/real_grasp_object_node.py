...
def moverobot(frame_id = "base_link") -> geometry_msgs.msg.Pose:
    ...
    goal_position = [(pose_grasp[0])/1000,(pose_grasp[1])/1000,(pose_grasp[2]+70)/1000]
    goal_pose = construct_pose(goal_position[0:3], rot_angle[0:3], frame_id='base_link')

    # Up pose
    up_position = [(pose_grasp[0])/1000,(pose_grasp[1])/1000,(pose_grasp[2]+140)/1000]
